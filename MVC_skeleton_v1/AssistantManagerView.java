...
public class AssistantManagerView implements ViewInterface {
    ...
    ViewData selectOperation(ModelData modelData) throws Exception {
        ...
        if (resultSet != null) {
            while (resultSet.next()) {
                ...
                int assistantManagerID = resultSet.getInt("AssistantManagerID");
    ...
    Map<String, Object> getWhereParameters() throws Exception {
        ...
        Integer assistantManagerID = getInteger("AssistantManagerID: ",true);
        ...
        if (assistantManagerID != null) whereParameters.put("AssistantManagerID",assistantManagerID);
    ...
    ViewData insertGUI(ModelData modelData) throws Exception {
        Map<String, Object> parameters = new HashMap<>();
        parameters.put("fieldNames", "Name, Surname, AssistantManagerID, Salary, DutyStartDate, ResidentID, ManagerID");

        List<Object> rows = new ArrayList<>();

        String name, surName;
        Integer  managerID, salary, residentID;
        do
        {
            ...
            if (name != null && surName != null &&  managerID!=null && salary!=null) {
                rows.add(new AssistantManager(name, surName,  salary, residentID, managerID));
            }
        }
        while (name != null && surName != null  && managerID!= null && salary!=null );
